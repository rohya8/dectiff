...
import com.rns.tiffeat.mobile.adapter.ScheduledOrderListAdapter.ViewHolder;
...
public class ScheduleOrderMealImageDownloaderTask extends AsyncTask<Meal, Void, Bitmap> {

	private ImageView imageView;
	private ViewHolder holder;

	public ScheduleOrderMealImageDownloaderTask(ViewHolder holder, ImageView mealImageView, Context context) {
		this.holder = holder;
		this.imageView = mealImageView;
	}

	public ScheduleOrderMealImageDownloaderTask(ViewHolder holder) {
		this.holder = holder;
	}
